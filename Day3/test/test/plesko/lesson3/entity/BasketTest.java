...
public class BasketTest {
    ...
    public void setUp() {
        ...
        try {
            basket.add(new Ball(310, 5, ColorBall.RED));
            basket.add(new Ball(240, 4.5, ColorBall.BLUE));
            basket.add(new Ball(542, 6.1, ColorBall.BLUE));
            basket.add(new Ball(432, 4.5, ColorBall.YELLOW));
            basket.add(new Ball(526, 5.3, ColorBall.VIOLET));
    ...
    public void addTest() {
        try {
            boolean actual = basket.add(new Ball(210, 2.5, ColorBall.BLUE));
    ...
    public void addExceptionMoreVolumeTest() {
        try {
            boolean actual = basket.add(new Ball(1230, 30, ColorBall.BLUE));
